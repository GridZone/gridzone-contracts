...
module.exports = async ({ deployments }) => {
  ...
  console.log("Now deploying PriceOracleUpgradeable on Mainnet...");
  ...
  console.log("Now deploying PriceOracleUpgradeableProxy on Mainnet...");
...
module.exports.tags = ["mainnet_PriceOracleUpgradeable"];
